...
"}")
        ...
        self.scrollArea.setGeometry(QRect(-20, 90, 231, 481))
        self.scrollArea.setStyleSheet(u"background-color: rgb(44, 44, 44);\n"
"border: None")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 231, 481))
...
"}")
        ...
        self.tableView.setGeometry(QRect(230, -10, 671, 631))
